...
public:
    ...
    std::string RenderPosts(SQLWrapper &wrapper, int groupId, bool isLeader, bool isAuthenticated, std::string user);
    ...
    std::string RenderGroupList(SQLWrapper &wrapper, int groupId, bool isAuthenticated, std::string user);
    std::string RenderLoginPage(bool isAuthenticated, std::string user);
    std::string RenderAdminPage(bool isAuthenticated, std::string user);
    std::string RenderSignupPage(bool isAuthenticated, std::string user);
private:
    Environment env;
};
