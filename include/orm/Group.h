...
public:
    ...
    static int AddGroup(SQLWrapper &db, const std::string &user_faculty, int user_number_departament, int user_course,
...
// TODO(A1i5k): May be delete
    ...
    static void UpdateGroup(SQLWrapper &db, int id_group, int user_number_departament, int user_course,
